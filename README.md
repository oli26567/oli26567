...
---
### [Testing and Analysing Cache Memory Access Time](https://github.com/oli26567/cachemem)
C + Python tool that measures memory latency and bandwidth to visualize the performance differences between CPU cache levels and RAM. Includes an optimized matrix multiplication study to demonstrate hardware-aware code efficiency.

**Tech**: C, Python, Tkinter, Matplotlib, CSV
